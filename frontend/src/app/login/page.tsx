  ...
  return (
    <div className="min-h-screen bg-[#1a1a1a] flex flex-col font-sans select-none">
      <main className="flex-1 flex items-center justify-center">
        <div className={`w-full min-h-screen bg-white flex flex-col items-center justify-center relative px-6 overflow-hidden group/form transition-all duration-700 ease-in-out
          ${isPending ? 'opacity-0 scale-95 pointer-events-none' : 'opacity-100 scale-100'}`}
        >
          
          <form action={formAction} className="w-full flex flex-col items-center relative">
            ...
            >
              ...
              <div className="w-100 h-100 bg-[#141414] rounded-full flex flex-col items-center justify-center relative shadow-lg group overflow-hidden">
                ...
                {/* 👄 ปากมหาภัย */}
                <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-27 h-7 bg-[#646363] rounded-sm transition-all duration-500 ease-in-out p-4 flex flex-col justify-center items-center mt-6
                  ...
                  <div className="form-inner-content w-full flex flex-col gap-3 h-0 opacity-0 pointer-events-none transition-all duration-500 ease-in-out 
                                  group-focus-within/form:h-auto group-focus-within/form:opacity-100 group-focus-within/form:pointer-events-auto">
                    
                    <h3 className="text-center font-bold text-sm text-black mb-1 tracking-wider uppercase opacity-80">Welcome Back</h3>
            ...
            {/* ⚠️ Error Message */}
            {state?.error && (
              <p className="text-xs text-red-500 mt-4 animate-pulse">{state.error}</p>
            )}
